...
import (
	...
	"github.com/shasan101/db-backup-gen/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "363d6871.shasan.com",
	...
	if err = (&controller.DbWatcherReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DbWatcher")
		os.Exit(1)
	}
